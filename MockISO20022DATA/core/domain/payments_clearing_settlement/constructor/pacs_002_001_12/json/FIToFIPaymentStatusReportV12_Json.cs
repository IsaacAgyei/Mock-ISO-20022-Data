...
public class FIToFIPaymentStatusReportV12_JSON : GenerateJson
{
  ...
  public FIToFIPaymentStatusReportV12_JSON()
  {
  ...
  public JsonNode ActiveOrHistoricCurrencyAndAmount_SimpleType()
  {
    ...
    */
    ...
    {
      return (JsonNode)convertedDecimal;
    }
    else
    {
  ...
  public JsonNode AddressType2Code()
  {
    ...
    return (JsonNode)addressType2Code[randomNumber];
  }
  ...
  */
  ...
  public JsonNode CreditDebitCode()
  {
    ...
    */
    ...
    return (JsonNode)codes[randomNumber];
  }
  ...
  public JsonNode Exact2NumericText()
  {
    ...
    */
    ...
    return (JsonNode)randomStringNumber;
  }
  ...
  public JsonNode Number()
  {
    ...
    */
    int randomNumber = new Random().Next(999_999_999);

    if (randomNumber < 999_999_999)
    {
      return (JsonNode)randomNumber;
    }
    else
    {
      throw new NotImplementedException();
  ...
  public JsonNode PhoneNumber()
  {
    ...
    */
    ...
    return (JsonNode)phoneNumber.ToString();
  }
